...
import com.purplefront.jiro_dev.parsers.Image_JSONParser;
import com.purplefront.jiro_dev.parsers.ProductDescription_JSONParser;
import com.purplefront.jiro_dev.parsers.Student_View_All_JSONParser;
...
public class Product_Description extends ActionBarActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener{
    ...
    List<Student_View_All_Model> feedslist1;
    Spinner spnr_proitems;

    ArrayList<String> price = new ArrayList<>();
    ArrayList<String> uom_name = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview = (ExpandableListView) findViewById(R.id.prodspec);

        spnr_proitems = (Spinner)findViewById(R.id.select_proitems);
        ...
        try {
            ...
            //getSupportActionBar().setSubtitle("Product Description");
...
//        });
        ...
        getimage_data1(getResources().getString(R.string.url_reference) + "home/product_attr.php");
...
//    }
    ...
    private void getimage_data1(String uri) {
        StringRequest request = new StringRequest(Request.Method.POST, uri, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                feedslist1 = Student_View_All_JSONParser.parserFeed(s);
                listview.setAdapter(new Product_Desc_Adapter(Product_Description.this,feedslist1));
        ...
        if(feedlist_image != null) {
            try {
                ...
                for (Image_Model flower : feedlist_image) {
                    //Log.d("image name",flower.getName());
                    //Log.d("image",flower.getImage());
                    if (flower.getName().equals("null") || flower.getName().equals("")) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST,url,new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
...

                {
                    ...
                    basic = jsonObject.getString("basic_details");
                    String uom = jsonObject.getString("uom_list");
                    JSONArray ar = new JSONArray(uom);
                    for(int i=0;i<ar.length();i++)
                    {
                        JSONObject obj = ar.getJSONObject(i);
                        price.add(obj.getString("uom_name") + " - " + "₹"+ obj.getString("price")) ;


                    }

                    ArrayAdapter<String> adapter3_grade=new ArrayAdapter<>(Product_Description.this,android.R.layout.simple_spinner_dropdown_item,price);
                    adapter3_grade.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    spnr_proitems.setAdapter(adapter3_grade);
                ...
                feedlist = ProductDescription_JSONParser.parserFeed(basic);
                display_data();
            }
        }, new Response.ErrorListener() {
            @Override
        ...
        if (feedlist != null) {
            try {
                for (final Product_Description_Model flower : feedlist) {
                    ...
                    TextView code_name = (TextView)findViewById(R.id.code_name);
                    code_name.setText(flower.getCode_name());

//                    TextView price_name = (TextView)findViewById(R.id.price_name);
//                    //price_name.setText("₹"+flower.getPrice_name());
//
//                    if(flower.getPrice_name().equals("null"))
//                    {
//                        price_name.setText("");
//                    }
//                    else
