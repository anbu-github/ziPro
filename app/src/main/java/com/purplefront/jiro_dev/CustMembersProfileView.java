...
public class CustMembersProfileView extends ActionBarActivity {
    ...
    Button viewContacts,approvebtn,rejectbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.custmembersprofile_view);

        progress = new ProgressDialog(CustMembersProfileView.this);
        ...
        btn_add_address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CustMembersProfileView.this,CreateCust_Address.class);
                ...
                CustMembersProfileView.this.finish();
        ...
        viewContacts.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(CustMembersProfileView.this,ViewContact.class);
                intent.putExtra("cust_id",StaticVariable.customer_segment_cust_id);
                intent.putExtra("name",name);
                intent.putExtra("id",StaticVariable.customer_segment_id);
                CustMembersProfileView.this.finish();
        ...
        mLayoutManager1 = new GridLayoutManager(CustMembersProfileView.this, 1);
        ...
        if (isonline()) {
            ...
            Toast.makeText(CustMembersProfileView.this, getResources().getString(R.string.nointernetconnection), Toast.LENGTH_LONG).show();
        }
        ...
        for(int i=0; i<StaticVariable.actionidList.size();i++) {
            if(StaticVariable.actionidList.get(i).equals("1")) {
                ...
                if(StaticVariable.per_id >= permit) {
                    approverejectlay.setVisibility(View.GONE);
                    break;
                } else {
                    approverejectlay.setVisibility(View.VISIBLE);

                    approvebtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            ApprovedCustomer(getResources().getString(R.string.url_reference) + "home/customer_approve_status.php");
                        }
                    });
                    ...
                    rejectbtn.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            RejectCustomer(getResources().getString(R.string.url_reference) + "home/customer_detete.php");
                        }
                    });
    ...
    private void RejectCustomer(String url)
    {
        StringRequest request = new StringRequest(Request.Method.POST,url,new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                progress.hide();
                Log.d("DELCUS","DELCUS"+s);


                AlertDialog.Builder builder = new AlertDialog.Builder(CustMembersProfileView.this);
                builder.setMessage(getResources().getString(R.string.customer_remove_success))
                        .setCancelable(false)
                        ...
                        .setPositiveButton(getResources().getString(R.string.ok), new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent intent = new Intent(CustMembersProfileView.this, CustomerFragActivity.class);
            ...
            public void onErrorResponse(VolleyError volleyError) {
                progress.hide();
                Toast.makeText(CustMembersProfileView.this, getResources().getString(R.string.nointernetconnection1), Toast.LENGTH_LONG).show();
                Toast.makeText(CustMembersProfileView.this,volleyError.getMessage(),Toast.LENGTH_LONG).show();
            }
        }) {
...
//            mRecyclerView.setAdapter(mAdapter);
        ...
        {
            mAdapter1 = new Cust_Add_Adaptor(addslist, CustMembersProfileView.this,"categoires");
    ...
    {
        ConnectivityManager cm = (ConnectivityManager) CustMembersProfileView.this.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public void goback()
    {
        ...
        this.finish();
        startActivity(intent);
        CustMembersProfileView.this.overridePendingTransition(R.anim.push_right_in, R.anim.push_right_out);
