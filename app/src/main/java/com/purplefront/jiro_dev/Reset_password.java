...
public class Reset_password extends ActionBarActivity{
    EditText et;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle((Html.fromHtml("<font color=\"" + getResources().getString(R.string.actionbar_text_color) + "\">" + "Forgot Password" + "</font>")));
