...
public class ViewContact1 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress = new ProgressDialog(ViewContact1.this);
        ...
        mLayoutManager = new GridLayoutManager(ViewContact1.this, 1);
        ...
        if (isonline()) {
            ...
            Toast.makeText(ViewContact1.this, getResources().getString(R.string.nointernetconnection), Toast.LENGTH_LONG).show();
        }
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ViewContact1.this,CreateCustomerContact.class);
    ...
    private void display_data()
    {
        ...
        if(feedlist != null) {
            ...
            if(!feedlist.get(0).getName().equals("No Data"))
            {
                ...
                mAdapter = new Cust_Contact_Adapter(feedlist, ViewContact1.this);
    ...
    private void getcontacts(String url)
    {
        StringRequest request = new StringRequest(Request.Method.POST,url,new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError volleyError) {
                progress.hide();
                Toast.makeText(ViewContact1.this, getResources().getString(R.string.nointernetconnection1), Toast.LENGTH_LONG).show();
                Toast.makeText(ViewContact1.this,volleyError.getMessage(),Toast.LENGTH_LONG).show();
            }
        }) {
    ...
    {
        ConnectivityManager cm = (ConnectivityManager) ViewContact1.this.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                Intent intent = new Intent(ViewContact1.this, CustMembersProfileView1.class);
                ...
                startActivity(intent);
                ViewContact1.this.finish();
                ViewContact1.this.overridePendingTransition(R.anim.push_right_in, R.anim.push_right_out);
                return true;
            default:
                return true;
        }
